...
<div class="col-md-12">				
			<div class="panel panel-inverse">
				...
				<div class="panel-heading">
					...
					<h4 class="panel-title">List Data OKP (Dengan Validasi Bin)</h4>
				</div>
					</br>
					<div>
					</div>
						...
						<?php 
          				...
          				?>
							<tr class="odd gradeX">
								...
								<td><?=$data->uom_scale ?> </td>
								
								<td class="text-center" width="15%">
									<a href="<?=site_url('c_transaction2/transaction_validasi/'.$data->batch_no.'')?>" class="btn btn-success btn-xs fa fa-shopping-cart"> Transaction </a>
									</a>
								</td>
								<td class="text-center" width="15%">
